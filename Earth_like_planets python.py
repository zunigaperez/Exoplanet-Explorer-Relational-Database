...
discovery_columns=['Host Name','Discovery Method', 'Discovery Year', 'Discovery Facility']
...
discoveries_data.drop_duplicates(subset=['Discovery Method', 'Discovery Year', 'Discovery Facility'], inplace=True)
